...
#include "ugv_robot_msgs/msg/detail/health__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const ugv_robot_msgs::msg::Health *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ugv_robot_msgs::msg::Health *>(
    untyped_ros_message);
...
{
  return &ugv_robot_msgs::msg::typesupport_fastrtps_cpp::_Health__handle;
}
