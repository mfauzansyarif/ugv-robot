...
class Health(metaclass=Metaclass_Health):
    ...
    def __init__(self, **kwargs):
        ...
        self.stm32_status = kwargs.get('stm32_status', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.stm32_status != other.stm32_status:
            return False
        return True
    ...
    @property
    def stm32_status(self):
        """Message field 'stm32_status'."""
        return self._stm32_status

    @stm32_status.setter
    def stm32_status(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'stm32_status' field must be of type 'int'"
            assert value >= 0 and value < 256, \
                "The 'stm32_status' field must be an unsigned integer in [0, 255]"
        self._stm32_status = value
