...
static const _PersonDetection_type_support_symbol_names_t _PersonDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ugv_robot_msgs, msg, PersonDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ugv_robot_msgs, msg, PersonDetection)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ugv_robot_msgs, msg, PersonDetection)() {
  return &::ugv_robot_msgs::msg::rosidl_typesupport_c::PersonDetection_message_type_support_handle;
}
