"""Monitor debug print dari STM32 (board G474RE) lewat LPUART1 (ST-LINK VCP).
...
Catatan: BAUDRATE di bawah ini 115200, baudrate debug era firmware lama.
Firmware produksi sekarang di Code/NucleoG474RE pakai LPUART1 @ 209700 -
kalau mau pakai script ini ke firmware CURRENT, update dulu nilai BAUDRATE-nya.
