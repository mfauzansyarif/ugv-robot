"""Baca langsung output Arduino Mega Pro (Code/ArduinoMegaPro/ArduinoMegaPro.ino)
lewat serial, buat verifikasi SEMUA input (joystick + tombol) kebaca bener
sebelum disambungin ke GCS app.

Format 12 field, urutan SAMA PERSIS kayak ArduinoReader di
Code/Asus NUC/serial_workers.py:
  X Y lrf zoomin zoomout bodyup bodydown lampu cam_atas cam_kanan cam_bawah cam_kiri

Baudrate 57600 (sama kayak Serial.begin() di ArduinoMegaPro.ino).
