...
protokol) - script INI simulasi 2 lapis SEKALIGUS dalam 1 proses:
  ...
  2. Logic penerjemah `_bangun_frame_gcs()` dari Code/Asus NUC/main_window.py
...
Field "widget touchscreen gcs_app" (bukan dari Arduino):
  ...
  motorid        0-10       dialog Kontrol Motor Linear Individual - 1-4
                             ...
                             Code/Asus NUC/motor_linear_dialog.py
...
FORMAT_REQUEST = "=BbbbbbBBBBbBbBB"   # 15 byte, SAMA kayak Code/Asus NUC/serial_workers.py
...
def axis_ke_signed(nilai_mentah):
    """PERSIS sama kayak MainWindow._axis_ke_signed di Code/Asus NUC/main_window.py."""
