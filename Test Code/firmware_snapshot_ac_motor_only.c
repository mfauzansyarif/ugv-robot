...
/* CATATAN: snapshot arsip firmware, BUKAN kode produksi saat ini - dari fase
 * waktu firmware cuma ngontrol 4 motor AC (sebelum RS485/aktuator/lampu
 * ditambah). Dipertahankan karena pasangan tes-nya masih ada: test_ac_motors_stm32.py.
 * Baudrate di sini (LPUART1=115200, USART3=57600) SUDAH USANG - beda dari
 * firmware produksi sekarang di Code/NucleoG474RE (LPUART1=209700, USART3=115200).
 */
/**
  ******************************************************************************
  * @file           : main.c
