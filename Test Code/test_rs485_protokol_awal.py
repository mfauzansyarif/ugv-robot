...
Protokol yang benar ditemukan dari kode Jetson versi lama yang sudah tidak ada di repo,
tapi sudah pernah dites dan kebukti jalan di hardware fisik.
...
# Kalibrasi sudut hasil pengukuran empiris ke unit fisik ini (dari kode Jetson versi lama)
