...
Baudrate FIX di 57600 (bukan 115200 kaya di komentar main_code_ros.cpp - source
lama dari codebase pre-STM32G474 yang udah gak ada di repo, disebut cuma buat
konteks historis) - sudah kebukti empiris 115200 bikin data ke-korup pas
dikirim (perintah "rem" malah nge-gerakin motor linear yang gak dimaksud).
Kemungkinan firmware yang beneran ke-flash di board beda baudrate dari source
main_code_ros.cpp itu.
