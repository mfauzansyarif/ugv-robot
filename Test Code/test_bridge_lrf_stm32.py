"""Test tool VALIDASI FIRMWARE BRIDGE STM32 (firmware_snapshot_lrf_bridge_g431kb.c)
TANPA perlu LRF fisik nyala. Caranya: 2 port serial dipakai bersamaan di laptop.
...
WIRING PIN STM32 (NUCLEO-G431KB, sesuai firmware_snapshot_lrf_bridge_g431kb.c):
...
Prasyarat: STM32 sudah diflash firmware_snapshot_lrf_bridge_g431kb.c dan lagi nyala.
