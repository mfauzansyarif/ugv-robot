...
Ini versi sederhana (tanpa GUI/kamera), mirip logic relay yang dulu ada di
app GCS versi lama - cuma fokus buat ngetes: data dari Arduino beneran
nyampe & diterusin ke radio TX apa nggak.
