...
Frame ke STM32 (format BARU, terpisah dari frame 8-field utama):
  "I <index 1-12> <dir -1/0/1>\n"

CATATAN: PROOF-OF-CONCEPT - firmware STM32 BELUM support command "I ..." ini
(ProsesFrame8 yang sekarang cuma parse frame 8-field grouping, perlu
direvisi dulu biar bisa nerima frame ini).

Requirement: pip install pyserial (tkinter sudah bawaan Python)
"""
