...
/* CATATAN: snapshot arsip firmware bench-test paling awal/minimal, disimpan
 * cuma buat referensi historis - TIDAK dipasangkan dengan script tes tertentu
 * yang ada sekarang. Baudrate di sini JANGAN dijadikan acuan buat firmware
 * produksi saat ini.
 */
/**
  ******************************************************************************
