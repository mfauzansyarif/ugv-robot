...
Code/NucleoG474RE/Core/Src/main.c, TANPA perlu device fisik (pantilt/kamera/
LRF-bridge beneran) - karena belum bisa pegang hardware-nya langsung.
...
==================== WIRING ====================
(WAJIB disilang RX<->TX, GND WAJIB nyambung, VCC JANGAN disambung)
