"""Verifikasi protokol GCS/RF dari firmware Code/NucleoG474RE, pura-pura
...
Format frame (lihat dokumentasi/ROS2_BRIEF.md & Code/Asus NUC/serial_workers.py):
...
bener dulu (cek lewat test_debug_log_g474re.py, harus muncul "GCS RX: ..." sesuai
