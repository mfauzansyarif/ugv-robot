...
murni bareng versi echo firmware_snapshot_lrf_bridge_g431kb.c yang sekarang.
...
Kalau ini jalan sambil kamu pantau test_debug_log_g431kb_bridge.py,
"[STATUS] total byte masuk" HARUSNYA naik terus ngikutin jumlah yang dikirim
di sini. Kalau tetap diam di angka lama, itu bukti kuat masalahnya di
wiring/hardware (bukan soal timing/logic kode lagi).
