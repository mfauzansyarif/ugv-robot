...
static const _Health_type_support_symbol_names_t _Health_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ugv_robot_msgs, msg, Health)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ugv_robot_msgs, msg, Health)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ugv_robot_msgs, msg, Health)() {
  return &::ugv_robot_msgs::msg::rosidl_typesupport_c::Health_message_type_support_handle;
}
