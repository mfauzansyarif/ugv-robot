...
static const _Health_type_support_symbol_names_t _Health_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ugv_robot_msgs, msg, Health)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ugv_robot_msgs, msg, Health)),
  }
};
...
{
  return &::ugv_robot_msgs::msg::rosidl_typesupport_cpp::Health_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ugv_robot_msgs, msg, Health)() {
  return get_message_type_support_handle<ugv_robot_msgs::msg::Health>();
}
