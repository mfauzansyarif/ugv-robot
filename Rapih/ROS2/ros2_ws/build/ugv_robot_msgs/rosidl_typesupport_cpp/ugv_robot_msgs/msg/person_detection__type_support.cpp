...
static const _PersonDetection_type_support_symbol_names_t _PersonDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ugv_robot_msgs, msg, PersonDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ugv_robot_msgs, msg, PersonDetection)),
  }
};
...
{
  return &::ugv_robot_msgs::msg::rosidl_typesupport_cpp::PersonDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ugv_robot_msgs, msg, PersonDetection)() {
  return get_message_type_support_handle<ugv_robot_msgs::msg::PersonDetection>();
}
