"""Buka kamera RTSP dengan cara PERSIS SAMA kayak yang dipakai Jetson
(cv_node.py) - buat dijalanin di laptop Windows biar bisa dibandingin
visual sama tampilan video di GCS app (jalur RF analog TS832/RC832).
...
class KameraStream:
    """SAMA PERSIS kayak KameraStream di ROS2/cv_node.py - baca frame di
    thread terpisah, auto-reconnect kalau baca gagal berturut-turut."""
