...
/* Private defines -----------------------------------------------------------*/
#define LinearR_0_Pin GPIO_PIN_13
#define LinearR_0_GPIO_Port GPIOC
#define LinearL_0_Pin GPIO_PIN_14
#define LinearL_0_GPIO_Port GPIOC
#define LinearR_1_Pin GPIO_PIN_15
#define LinearR_1_GPIO_Port GPIOC
#define LinearL_4_Pin GPIO_PIN_0
#define LinearL_4_GPIO_Port GPIOF
#define LinearR_5_Pin GPIO_PIN_1
#define LinearR_5_GPIO_Port GPIOF
#define Lamp_F_Pin GPIO_PIN_0
#define Lamp_F_GPIO_Port GPIOC
#define Lamp_B_Pin GPIO_PIN_1
#define Lamp_B_GPIO_Port GPIOC
#define MotorS_2_Pin GPIO_PIN_2
#define MotorS_2_GPIO_Port GPIOC
#define MotorS_3_Pin GPIO_PIN_3
#define MotorS_3_GPIO_Port GPIOC
#define MotorS_0_Pin GPIO_PIN_0
#define MotorS_0_GPIO_Port GPIOA
#define MotorS_1_Pin GPIO_PIN_1
#define MotorS_1_GPIO_Port GPIOA
...
#define LinearL_5_Pin GPIO_PIN_5
#define LinearL_5_GPIO_Port GPIOA
#define MotorP_0_Pin GPIO_PIN_6
#define MotorP_0_GPIO_Port GPIOA
#define LinearR_6_Pin GPIO_PIN_7
...
#define LinearL_1_GPIO_Port GPIOC
#define LinearR_2_Pin GPIO_PIN_8
#define LinearR_2_GPIO_Port GPIOC
#define LinearL_2_Pin GPIO_PIN_9
#define LinearL_2_GPIO_Port GPIOC
#define LinearL_6_Pin GPIO_PIN_8
#define LinearL_6_GPIO_Port GPIOA
#define LinearR_7_Pin GPIO_PIN_9
#define LinearR_7_GPIO_Port GPIOA
#define LinearL_7_Pin GPIO_PIN_10
...
#define LinearR_3_Pin GPIO_PIN_10
#define LinearR_3_GPIO_Port GPIOC
#define LinearL_3_Pin GPIO_PIN_11
